...
map.getView().fit([2343698.132725, 6875823.055989, 2413987.496273, 6930018.334985], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza zmiany przebiegu rzeki Bug w latach 1940 - 2025</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (511 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Projekt obejmował analizę jakościową i ilościową zmian przebiegu koryta rzeki Bug w latach 1940 – 2025. Została ona przeprowadzona w celu lepszego zrozumienia i poznania współczesnego krajobrazu obszarów wokół rzeki Bug, dostrzeżenia czynników wpływających na charakter i strukturę elementów krajobrazu. Jest to wykorzystywane przy m.in. określaniu prawdopodobieństwa występowania zagrożeń naturalnych, co umożliwia dokonanie właściwych działań w zakresie planowania przestrzennego oraz zarządzania kryzysowego.';
            }
